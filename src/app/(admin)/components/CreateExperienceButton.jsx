'use client';
export const CreateExperienceButton = ({ actionFunction }) => {
  return (
        <button onClick={() => actionFunction()} className="flex gap-3 py-5 px-8 border-2 border-primary rounded-[40px] text-2xl font-semibold text-primary">
